...
// Source: stub/github.com/csuJudge/javaProto/javaSolution/java_solution.trpc.go
//
// Generated by this command:
//
//	mockgen -destination=stub/github.com/csuJudge/javaProto/javaSolution/java_solution_mock.go -package=javaSolution -self_package=github.com/csuJudge/javaProto/javaSolution --source=stub/github.com/csuJudge/javaProto/javaSolution/java_solution.trpc.go
//
...
func (m *MockSolutionServerService) QueryLatestCode(ctx context.Context, req *QueryLatestCodeReq) (*QuerySourceCodeRsp, error) {
	m.ctrl.T.Helper()
...
// QueryLatestCode mocks base method.
func (m *MockSolutionServerClientProxy) QueryLatestCode(ctx context.Context, req *QueryLatestCodeReq, opts ...client.Option) (*QuerySourceCodeRsp, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
